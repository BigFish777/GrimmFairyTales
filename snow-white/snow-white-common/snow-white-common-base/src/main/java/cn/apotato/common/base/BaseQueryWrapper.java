package cn.apotato.common.base;
...
import static cn.apotato.common.base.BaseConstant.*;
...
public class BaseQueryWrapper <T> {
     ...
     * @return {@link MPJQueryWrapper}<{@link T}>
     * @throws IllegalAccessException 非法访问异常
     */
    public MPJQueryWrapper<T> createMPJLambdaQueryWrapper(T entity, boolean isOrderBy) throws IllegalAccessException {
     ...
     * 处理：排序，时间区间
     */
    public Field[] HandlingOfSpecialFields(MPJQueryWrapper<T> queryWrapper, Field[] fields, T entity, boolean isOrderBy) throws IllegalAccessException {
     ...
     * @param value           价值
     */
    public void setFieldQueryCriteria(MPJQueryWrapper<T> queryWrapper, Class<?> fieldType, String tableFieldValue, Object value) {
        // 如果字段为字符串，则使用like
