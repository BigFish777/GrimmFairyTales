...
@Configuration
public class KafkaInitialConfiguration implements BeanPostProcessor {

    @Resource
    private KafkaExtendProperties properties;
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (topics != null) {
            topics.forEach(topic -> SpringUtils.registerBean(topic, new NewTopic(topic, properties.getNumPartitions(), properties.getReplicationFactor())));
        }
